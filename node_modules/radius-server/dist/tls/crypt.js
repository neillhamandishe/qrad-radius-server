...
export function startTLSServer(tlsOptions, logger) {
    ...
    cleartext.on('resumeSession', (sessionId, callback) => {
        const resumedSession = resumeSessions.get(sessionId.toString('hex')) || null;
        if (resumedSession) {
